                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        ...
                        <ul class="nav nav-pills">
                            ...
                            <li><a href="https://www.facebook.com/crc.edinburgh" target="_blank" title="CRC on Facebook"><i class="fa fa-facebook fa-lg">&nbsp;</i></a></li>
                            <li><a href="https://twitter.com/CRC_EdUni" target="_blank" title="CRC on Twitter"><i class="fa fa-twitter fa-lg">&nbsp;</i></a></li>
                            <li><a href="./feedback" title="Provide feedback"><i class="fa fa-envelope fa-lg">&nbsp;</i></a></li>
                        </ul>
                        </div>
                    </div>
                    <div class="col-md-3 hidden-sm hidden-xs">
                        <a class="navbar-brand navbar-left" href="https://www.ed.ac.uk" title="The University of Edinburgh Homepage Link" target="_blank"><img src="<?php echo base_url(); ?>theme/stcecilia/images/UoETransparentWhite.png" class="img-responsive uoe_logo" alt="University of Edinburgh link" /></a>
                    </div>
                </div>
                <div class="row">
